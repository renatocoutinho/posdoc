...
{\it
    ...
    comunidades à dinâmica de metacomunidades.  Para isso, deve-se
...
biblioteca para matemática simbólica SymPy \citep{sympy}.
...
% difícil..
Esta última etapa consiste em conectar as hipóteses assumidas no início às
conclusões obtidas, buscando compreender o mecanismo que leva das primeiras às
últimas à luz do modelo desenvolvido. As questões de interesse ecológico só
